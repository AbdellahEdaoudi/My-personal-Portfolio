...
import {QualifEn,QualifFr} from "./data/Data.Qualif"
...
function Qualif() {
  ...
  return (
    <section
      id="Qlf"
      className="bg-gray-50 flex  flex-col items-center pt-4  px-5  md:px-10 pb-10"
    >
        ...
        <div className={` md:flex  justify-center md:space-x-10 md:space-y-0 space-y-5`}>
          ...
          <div className=" hover:scale-105 duration-300 bg-white border md:w-[380px] px-0.5 flex flex-col items-center pt-4 pb-5 shadow-lg rounded-lg">
            <div className="pb-1">
              ...
              {/* Alert Dialog */}
              <div className="hover:text-sky-500  flex justify-end mr-5">
              <AlertDialog >
                <AlertDialogTrigger>
                  <div className="bg-sky-100 my-1 rounded-md p-2 hover:scale-105 duration-300" >
                    {EnOrFr === "en" ? "Show My Experience" : "Montrer mon expérience"}</div>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
          ...
          {/* BAB AHMED */}
          <div className="hover:scale-105 duration-300 text-center pb-4 bg-white border md:w-[380px] px-0.5 flex flex-col items-center pt-4  shadow-lg rounded-lg">
            <h1 className="pb-2">
      ...
      <div className={`${Qlf ? "block" : "hidden"}`}>
        ...
        >
          {/* STAGE */}
<div className="bg-white border px-5 md:px-10 md:flex items-start pt-7 pb-10 shadow-lg rounded-lg">
