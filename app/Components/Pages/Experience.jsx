            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="grid gap-6">
                    {content.items && content.items.map((item, index) => (
                        <div key={index} className="bg-white border border-gray-100 rounded-xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-shadow duration-300 overflow-hidden">
                            {/* Card Top Border */}
